...
public class ServiceProvider {
    ...
    protected static ClassLoader getClassLoader(Class<?> clazz) {
        try {
            ...
            LOG.error("Unable to get classloader for class {} due to security restrictions !{}", clazz, e.getMessage());
            throw e;
        }
    }
            ...
            if (classLoader != null) {
                try {
                    ...
                    if (clazz.isAssignableFrom(serviceClazz)) {
                        ...
                        LOG.error(
                                "Class {} loaded from classloader {} does not extend {} as loaded by this classloader.", serviceClazz.getName(), objectId(serviceClazz.getClassLoader()), clazz.getName());
                    }
