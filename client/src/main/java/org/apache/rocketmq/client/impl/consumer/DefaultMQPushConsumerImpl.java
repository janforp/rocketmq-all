...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
     ...
     *
     * @see ConsumeMessageConcurrentlyService 并发消费
     * @see ConsumeMessageOrderlyService 顺序消费
     */
    @Getter
    @Setter
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        PullCallback pullCallback = new PullCallback() {
            ...
            public void onException(Throwable e) {
                ...
                DefaultMQPushConsumerImpl.this.executePullRequestLater(pullRequest, pullTimeDelayMillsWhenException/*1秒*/);
            }
        };
    ...
    public void sendMessageBack(MessageExt msg, int delayLevel, final String brokerName) throws RemotingException, MQBrokerException, InterruptedException, MQClientException {
        try {
            ...
            mqClientAPIImpl.consumerSendMessageBack(brokerAddr, msg, this.defaultMQPushConsumer.getConsumerGroup(), delayLevel, 5000, getMaxReconsumeTimes());
        } catch (Exception e) {
        ...
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                if (this.defaultMQPushConsumer.getMessageModel() == MessageModel.CLUSTERING) {
                    // 集群模式，修改消费者实例名称为 进程 PID，instanceId
                ...
                if (!registerOK) {
                    ...
                    this.consumeMessageService.shutdown();
                    throw new MQClientException("The consumer group[" + consumerGroup + "] has been created before, specify another name please." + FAQUrl.suggestTodo(FAQUrl.GROUP_NAME_DUPLICATE_URL), null);
                }
    ...
    private void copySubscription() throws MQClientException {
        try {
            ...
            if (this.defaultMQPushConsumer.getMessageModel() == MessageModel.CLUSTERING) {
                ...
                // 消息重试的主题，因为会有消费失败的情况
                final String retryTopic/* %RETRY%消费者组名 */ = MixAll.getRetryTopic(this.defaultMQPushConsumer.getConsumerGroup());
                // 创建该重试主题的订阅数据对象
