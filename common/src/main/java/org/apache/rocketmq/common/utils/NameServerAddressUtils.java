...
public class NameServerAddressUtils {
    ...
    public static String getNameServerAddresses() {
        //获取环境变量
        String namesrvAddr = System.getenv(MixAll.NAMESRV_ADDR_ENV);
        //先取 rocketmq.namesrv.addr 对应的值，如果取不到，则取 NAMESRV_ADDR 环境变量
        return System.getProperty(MixAll.NAMESRV_ADDR_PROPERTY, namesrvAddr);
    }
